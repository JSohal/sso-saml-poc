    ...
    namespace Saml
    {
        ...
        public class Response
        {
            ...
            public DateTime? NotBefore()
            {
                ...
                XmlNodeList nodes = xmlDoc.SelectNodes("/samlp:Response/saml:Assertion/saml:Conditions", manager);
                string value = null;
            ...
            public string GetStatus()
            {
                ...
                manager.AddNamespace("saml", "urn:oasis:names:tc:SAML:2.0:assertion");
                manager.AddNamespace("samlp", "urn:oasis:names:tc:SAML:2.0:protocol");               
                XmlNode node = xmlDoc.SelectSingleNode("/samlp:LogoutResponse/samlp:Status/samlp:StatusCode/@Value", manager);
            ...
            public string GetSessionId()
            {
                ...
                manager.AddNamespace("saml", "urn:oasis:names:tc:SAML:2.0:assertion");
                manager.AddNamespace("samlp", "urn:oasis:names:tc:SAML:2.0:protocol");
                XmlNode node = xmlDoc.SelectSingleNode("/samlp:Response/saml:Assertion/saml:AuthnStatement/@SessionIndex", manager);
                return node.InnerText;
            }
